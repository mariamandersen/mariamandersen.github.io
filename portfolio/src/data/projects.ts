...
export const projects: Project[] = [
  {
    ...
    questionNo: "Hvordan kan forskere og stab få oversikt over hvor forskningsdata er lagret, uten å skape mer dobbeltregistrering?",
    questionEn: "How can researchers and administrative staff find where research data is stored without creating more duplicate registration?",
