import svgPaths from "./svg-sy5ps35j18";
...
function Text1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.8)] whitespace-nowrap">2 datasett</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="flex-[803_0_0] gap-x-[16px] gap-y-[16px] grid grid-cols-[___257px_257px_257px] grid-rows-[_150px] h-[150px] min-w-px relative" data-name="Container">
      <DataCard />
      <DataCard1 />
    </div>
  );
...
function CatalogPage2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pb-[48px] px-[24px] top-[12px] w-[1101px]" data-name="CatalogPage">
      <Container1 />
      <Container2 />
    </div>
  );
...
export default function FilterProjectNameActive() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="filter-project-name-active">
      <Body />
      <CatalogPage1 />
      <CatalogPage2 />
    </div>
