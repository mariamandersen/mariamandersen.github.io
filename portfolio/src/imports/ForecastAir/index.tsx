import svgPaths from "./svg-t4nke4fmnp";

function Frame() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[127px]">
      <p className="leading-[32px] relative shrink-0 text-[24px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        29.03
      </p>
      <p className="leading-[20px] relative shrink-0 text-[14px] tracking-[0.25px] w-full" style={{ fontVariationSettings: '"wdth" 100' }}>
        00:00 - 03:00
      </p>
    </div>
  );
...
function Frame1() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Roboto:Regular',sans-serif] font-normal gap-[12px] items-center relative shrink-0 text-[#1d1b20] text-left">
      <p className="leading-[40px] relative shrink-0 text-[32px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        🌤
      </p>
      <Frame />
    </div>
    ...
    <div className="relative shrink-0 size-[24px]" data-name="arrow_forward_ios">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="arrow_forward_ios">
          <mask height="24" id="mask0_0_154" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="#D9D9D9" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_0_154)">
            <path d={svgPaths.p11a80500} fill="#1D1B20" id="arrow_forward_ios_2" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame7() {
  return (
    <a className="absolute bg-white content-stretch cursor-pointer flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[813px] w-[364px]">
      <Frame1 />
      <ArrowForwardIos />
    </a>
  );
...
function Frame2() {
  return (
    <a className="absolute bg-white content-stretch cursor-pointer flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[283px] w-[364px]">
      <Frame3 />
      <ArrowForwardIos1 />
    </a>
  );
...
function Frame5() {
  return (
    <a className="absolute bg-white content-stretch cursor-pointer flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[389px] w-[364px]">
      <Frame6 />
      <ArrowForwardIos2 />
    </a>
  );
...
function Frame9() {
  return (
    <a className="absolute bg-white content-stretch cursor-pointer flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[495px] w-[364px]">
      <Frame10 />
      <ArrowForwardIos3 />
    </a>
  );
...
function Frame12() {
  return (
    <a className="absolute bg-white content-stretch cursor-pointer flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[601px] w-[364px]">
      <Frame13 />
      <ArrowForwardIos4 />
    </a>
  );
...
function Frame15() {
  return (
    <a className="absolute bg-white content-stretch cursor-pointer flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[707px] w-[364px]">
      <Frame16 />
      <ArrowForwardIos5 />
    </a>
  );
    ...
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="state-layer">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[12px] py-[10px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#1b1b21] text-[14px] text-center tracking-[0.1px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Container1() {
  return (
    <div className="bg-[#e0e0f9] flex-[1_0_0] h-full min-w-px relative rounded-br-[12px] rounded-tr-[12px]" data-name="container">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <StateLayer5 />
      </div>
...
export default function ForecastAir() {
  return (
    <div className="bg-[#f5f5f5] border border-black border-solid relative size-full" data-name="Forecast - Air">
      <Frame7 />
      ...
      <Frame12 />
      <Frame15 />
      <div className="absolute left-[15px] top-[250px] w-[380px]" data-name="Horizontal/Divider with subhead">
      ...
      <Group />
      <div className="-translate-x-1/2 absolute bg-[rgba(255,255,255,0)] h-[47px] left-[calc(50%+1.5px)] top-[178px] w-[207px]" data-name="Segmented button">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch cursor-pointer flex items-center justify-center relative size-full">
            <a className="flex-[1_0_0] h-[48px] min-w-px mr-[-1px] relative rounded-[4px]" data-name="Segment-start">
              <div className="flex flex-row items-center justify-center size-full">
