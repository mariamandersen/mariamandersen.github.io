import svgPaths from "./svg-dq7rf8tzr8";
type Frame3Props = {
  className?: string;
...
function TrailingIcon() {
  return (
    <div className="content-stretch flex h-[48px] items-center justify-end relative shrink-0 w-[144px]" data-name="trailing-icon">
      <a className="block cursor-pointer overflow-clip relative shrink-0 size-[48px]" data-name="trailing-icon 3">
...
export default function ForecastGround() {
  return (
    <div className="bg-[#f5f5f5] border border-black border-solid relative size-full" data-name="Forecast - Ground">
