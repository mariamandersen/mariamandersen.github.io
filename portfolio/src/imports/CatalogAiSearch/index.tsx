import svgPaths from "./svg-m1ro8pelzq";
...
function PlaceholderForCatalogPage1() {
  return <div className="h-[685px] relative shrink-0 w-full" data-name="Placeholder for CatalogPage" />;
}
...
function CatalogPage() {
  return (
    <div className="bg-[#00574d] content-stretch flex flex-col h-[3346.75px] items-start min-h-[737px] overflow-clip relative shrink-0 w-full" data-name="CatalogPage">
...
function Container5() {
  return (
    <div className="bg-[#00574d] content-stretch drop-shadow-[0px_2px_5px_rgba(0,87,77,0.35)] flex flex-col items-start px-[16px] py-[10px] relative rounded-bl-[20px] rounded-br-[4px] rounded-tl-[20px] rounded-tr-[20px] self-stretch shrink-0" data-name="Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.25px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Jeg leter etter informasjon om sand i Ås</p>
    </div>
  );
}
...
function UserBubble() {
  return (
    <div className="content-stretch flex items-start justify-end relative shrink-0 w-full" data-name="UserBubble">
      <Container5 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
        <g id="Icon">
          <path d={svgPaths.p30651300} fill="white" id="Vector" opacity="0.9" />
        </g>
      </svg>
    </div>
  );
...
function AiAvatar() {
  return (
    <div className="bg-[#00574d] content-stretch drop-shadow-[0px_1px_2px_rgba(0,0,0,0.22)] flex items-center justify-center relative rounded-[16777200px] shrink-0 size-[28px]" data-name="AiAvatar">
      <Icon />
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21.125px] not-italic relative shrink-0 text-[13px] text-[rgba(0,0,0,0.8)] w-[702px]">Prosjektet studerer eoliske prosesser – vindtransport av sand – i norske kystmiljøer og høyfjellsområder. Det kartlegges hvilke arealer som er mest utsatt, og hvilke konsekvenser sandflukt har for naturtyper, veinettet og nærliggende bebyggelse. Feltmålinger kombineres med vindmodellering og fjernmåling. Datasettet er aktivt og oppdateres løpende. Det leveres i formatene CSV, GeoTIFF, NetCDF.</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Italic',sans-serif] font-normal italic leading-[21.125px] relative shrink-0 text-[13px] text-[rgba(0,0,0,0.7)] w-[702px]" style={{ fontVariationSettings: '"slnt" -14' }}>
        «leter» og «etter» dekkes ikke av dette datasettet. Treffet er delvis og du bør vurdere om det faktisk er relevant nok for formålet ditt.
      </p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="bg-[rgba(0,87,77,0.05)] content-stretch flex flex-col gap-[6px] items-start pb-[12px] pt-[14px] px-[16px] relative shrink-0 w-full" data-name="Container">
      <Paragraph1 />
      <Paragraph2 />
    </div>
  );
...
function Container7() {
  return <div className="border-[rgba(0,0,0,0.08)] border-solid border-t h-px relative shrink-0 w-full" data-name="Container" />;
}
...
function Text() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.25px] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Vindblåst sand og påvirkning på natur og infrastruktur</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[15px] not-italic relative shrink-0 text-[#00574d] text-[10px] whitespace-nowrap">55%</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start pb-[14px] pt-[12px] px-[16px] relative shrink-0 w-full" data-name="Container">
      <Container9 />
      <Container11 />
    </div>
  );
...
function ButtonVindblastSandOgPavirkningPaNaturOgInfrastrukturApneDmp() {
  return (
    <div className="bg-white content-stretch flex flex-[734_0_0] flex-col h-[263.5px] items-start min-w-px overflow-clip relative rounded-[17px] shadow-[0px_4px_14px_0px_rgba(0,0,0,0.18)]" data-name="Button - Vindblåst sand og påvirkning på natur og infrastruktur – åpne DMP">
      <Container6 />
      <ContainerMargin />
      <Container8 />
    </div>
...
function ChatResultItem() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="ChatResultItem">
      <AiAvatar />
      <ButtonVindblastSandOgPavirkningPaNaturOgInfrastrukturApneDmp />
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21.125px] not-italic relative shrink-0 text-[13px] text-[rgba(0,0,0,0.8)] w-[702px]">Prosjektet måler og modellerer transport av sand og finmateriale i utvalgte norske vassdrag, inkludert Glomma, Drammenselva og Orkla. Vannprøver og bunnsedimentprøver samles inn ved ulike vannføringer for å kvantifisere suspendert og bunnfast sedimenttransport. Dataene brukes til å kalibrere hydrologiske modeller. Merk at datasettet er avsluttet, men det er fortsatt tilgjengelig for nedlasting. Det leveres i formatene CSV, GeoJSON, PDF.</p>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.25px] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Fluvial sandtransport i norske vassdrag</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[15px] not-italic relative shrink-0 text-[#00574d] text-[10px] whitespace-nowrap">51%</p>
    </div>
  );
}
...
function ButtonFluvialSandtransportINorskeVassdragApneDmp() {
  return (
    <div className="bg-white content-stretch flex flex-[734_0_0] flex-col h-[263.5px] items-start min-w-px overflow-clip relative rounded-[17px] shadow-[0px_4px_14px_0px_rgba(0,0,0,0.18)]" data-name="Button - Fluvial sandtransport i norske vassdrag – åpne DMP">
      <Container14 />
      <ContainerMargin1 />
      <Container16 />
    </div>
...
function ChatResultItem1() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="ChatResultItem">
      <AiAvatar1 />
      <ButtonFluvialSandtransportINorskeVassdragApneDmp />
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21.125px] not-italic relative shrink-0 text-[13px] text-[rgba(0,0,0,0.8)] w-[702px]">Prosjektet kartlegger utbredelse, høyde og stabilitet av sanddynesystemer langs kysten fra Rogaland til Troms. Feltregistreringer kombineres med LiDAR-data og historiske flyfoto for å dokumentere endringer over tid. Formålet er å etablere et nasjonalt referansegrunnlag for kystdyner og identifisere arealer utsatt for erosjon. Merk at datasettet er avsluttet, men det er fortsatt tilgjengelig for nedlasting. Det leveres i formatene GeoJSON, GeoTIFF, PDF.</p>
    </div>
  );
}
...
function Text12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.25px] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Kartlegging av kystdyner langs norskekysten</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[15px] not-italic relative shrink-0 text-[#00574d] text-[10px] whitespace-nowrap">49%</p>
    </div>
  );
}
...
function ButtonKartleggingAvKystdynerLangsNorskekystenApneDmp() {
  return (
    <div className="bg-white content-stretch flex flex-[734_0_0] flex-col h-[284.625px] items-start min-w-px overflow-clip relative rounded-[17px] shadow-[0px_4px_14px_0px_rgba(0,0,0,0.18)]" data-name="Button - Kartlegging av kystdyner langs norskekysten – åpne DMP">
      <Container22 />
      <ContainerMargin2 />
      <Container24 />
    </div>
...
function ChatResultItem2() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="ChatResultItem">
      <AiAvatar2 />
      <ButtonKartleggingAvKystdynerLangsNorskekystenApneDmp />
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21.125px] not-italic relative shrink-0 text-[13px] text-[rgba(0,0,0,0.8)] w-[702px]">Prosjektet undersøker variasjoner i sandforekomster på ulike steder i Oslo. Det samles inn sandprøver som fotograferes og analyseres ved hjelp av sandkorntelling. Formålet er å kartlegge forskjeller i mengde og sammensetning mellom ulike områder. Prosjektet genererer både bilder av sandprøvene og prosesserte data fra analysene. Data lagres på NIBIOs interne lagringsløsning og gjøres tilgjengelig for prosjektdeltakerne. Datasettet er aktivt og oppdateres løpende. Det leveres i formatene CSV, PNG.</p>
    </div>
  );
}
...
function ButtonSandkorntellingApneDmp() {
  return (
    <div className="bg-white content-stretch flex flex-[734_0_0] flex-col h-[284.625px] items-start min-w-px overflow-clip relative rounded-[17px] shadow-[0px_4px_14px_0px_rgba(0,0,0,0.18)]" data-name="Button - Sandkorntelling – åpne DMP">
      <Container30 />
      <ContainerMargin3 />
      <Container32 />
    </div>
...
function ChatResultItem3() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="ChatResultItem">
      <AiAvatar3 />
      <ButtonSandkorntellingApneDmp />
    </div>
  );
}
...
function Paragraph9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21.125px] not-italic relative shrink-0 text-[13px] text-[rgba(0,0,0,0.8)] w-[702px]">Registrering av utvalgte naturtyper i kulturlandskapet etter Miljødirektoratets instruks. Dataene inngår i Naturbase og brukes i kommunale arealplaner. Datasettet er aktivt og oppdateres løpende. Det leveres i formatene GeoJSON, WFS.</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Italic',sans-serif] font-normal italic leading-[21.125px] relative shrink-0 text-[13px] text-[rgba(0,0,0,0.7)] w-[702px]" style={{ fontVariationSettings: '"slnt" -14' }}>
        «leter» og «informasjon» dekkes ikke av dette datasettet. Treffet er delvis og du bør vurdere om det faktisk er relevant nok for formålet ditt.
      </p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.25px] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Naturtyper kulturlandskap</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[15px] not-italic relative shrink-0 text-[#00574d] text-[10px] whitespace-nowrap">44%</p>
    </div>
  );
}
...
function ButtonNaturtyperKulturlandskapApneDmp() {
  return (
    <div className="bg-white content-stretch flex flex-[734_0_0] flex-col h-[242.375px] items-start min-w-px overflow-clip relative rounded-[17px] shadow-[0px_4px_14px_0px_rgba(0,0,0,0.18)]" data-name="Button - Naturtyper kulturlandskap – åpne DMP">
      <Container38 />
      <ContainerMargin4 />
      <Container40 />
    </div>
...
function ChatResultItem4() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="ChatResultItem">
      <AiAvatar4 />
      <ButtonNaturtyperKulturlandskapApneDmp />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[443px] items-start overflow-clip pb-[12px] px-[24px] relative shrink-0 w-full" data-name="Container">
      <UserBubble />
      <ChatResultItem />
      <ChatResultItem1 />
      <ChatResultItem2 />
...
function TextInputAiSokIDatakatalog() {
  return (
    <div className="content-stretch flex flex-[576.125_0_0] flex-col h-[22.5px] items-start justify-center min-w-px overflow-clip relative" data-name="Text Input - AI-søk i datakatalog">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-h-px not-italic relative text-[15px] text-[rgba(0,0,0,0.5)] w-[612px]">Beskriv hva du leter etter...</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
        <g clipPath="url(#clip0_0_6)" id="Icon">
          <path d="M1 1L11 11M11 1L1 11" id="Vector" stroke="black" strokeLinecap="round" strokeOpacity="0.5" strokeWidth="1.8" />
        </g>
        <defs>
...
function ButtonTomSok() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[16777200px] shrink-0 size-[28px]" data-name="Button - Tøm søk">
      <Icon11 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
        <g clipPath="url(#clip0_0_4)" id="Icon">
          <path d="M7 13L13 7L7 1M13 7H1" id="Vector" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
        <defs>
...
function ButtonSok() {
  return (
    <div className="bg-[#00574d] content-stretch flex gap-[6px] items-center justify-center px-[16px] py-[8px] relative rounded-[10px] shrink-0" data-name="Button - Søk">
      <Icon12 />
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Søk</p>
    </div>
  );
}
...
function CatalogPage3() {
  return (
    <div className="absolute content-stretch flex h-[685px] items-start justify-center left-0 pb-[24px] pt-[16px] px-[24px] top-[72px] w-[1101px]" data-name="CatalogPage">
      <Container2 />
    </div>
  );
}
...
function Text29() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(255,255,255,0.8)] whitespace-nowrap">5 treff for «Jeg leter etter informasjon om sand i Ås»</p>
    </div>
  );
}
...
function DataCard() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-self-stretch min-h-[150px] p-[16px] relative rounded-[17px] row-1 self-stretch shrink-0" data-name="DataCard">
      <Container68 />
      <Container69 />
    </div>
  );
...
function DataCard2() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-self-stretch min-h-[150px] p-[16px] relative rounded-[17px] row-1 self-stretch shrink-0" data-name="DataCard">
      <Container76 />
      <Container77 />
    </div>
  );
...
function DataCard5() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-2 self-stretch shrink-0" data-name="DataCard">
      <Container88 />
      <Container89 />
    </div>
  );
...
function DataCard6() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-3 self-stretch shrink-0" data-name="DataCard">
      <Container92 />
      <Container93 />
    </div>
  );
...
function DataCard7() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-3 self-stretch shrink-0" data-name="DataCard">
      <Container96 />
      <Container97 />
    </div>
  );
...
function DataCard8() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-3 self-stretch shrink-0" data-name="DataCard">
      <Container100 />
      <Container101 />
    </div>
  );
...
function DataCard9() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-4 self-stretch shrink-0" data-name="DataCard">
      <Container104 />
      <Container105 />
    </div>
  );
...
function DataCard10() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-4 self-stretch shrink-0" data-name="DataCard">
      <Container108 />
      <Container109 />
    </div>
  );
...
function DataCard11() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-4 self-stretch shrink-0" data-name="DataCard">
      <Container112 />
      <Container113 />
    </div>
  );
...
function DataCard12() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-5 self-stretch shrink-0" data-name="DataCard">
      <Container116 />
      <Container117 />
    </div>
  );
...
function DataCard13() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-5 self-stretch shrink-0" data-name="DataCard">
      <Container120 />
      <Container121 />
    </div>
  );
...
function DataCard14() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-5 self-stretch shrink-0" data-name="DataCard">
      <Container124 />
      <Container125 />
    </div>
  );
...
function DataCard15() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-6 self-stretch shrink-0" data-name="DataCard">
      <Container128 />
      <Container129 />
    </div>
  );
...
function DataCard16() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-6 self-stretch shrink-0" data-name="DataCard">
      <Container132 />
      <Container133 />
    </div>
  );
...
function DataCard17() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-6 self-stretch shrink-0" data-name="DataCard">
      <Container136 />
      <Container137 />
    </div>
  );
...
function DataCard18() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-7 self-stretch shrink-0" data-name="DataCard">
      <Container140 />
      <Container141 />
    </div>
  );
...
function DataCard19() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-7 self-stretch shrink-0" data-name="DataCard">
      <Container144 />
      <Container145 />
    </div>
  );
...
function DataCard20() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-7 self-stretch shrink-0" data-name="DataCard">
      <Container148 />
      <Container149 />
    </div>
  );
...
function DataCard21() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-8 self-stretch shrink-0" data-name="DataCard">
      <Container152 />
      <Container153 />
    </div>
  );
...
function DataCard22() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-8 self-stretch shrink-0" data-name="DataCard">
      <Container156 />
      <Container157 />
    </div>
  );
...
function DataCard23() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-8 self-stretch shrink-0" data-name="DataCard">
      <Container160 />
      <Container161 />
    </div>
  );
...
function DataCard24() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-9 self-stretch shrink-0" data-name="DataCard">
      <Container164 />
      <Container165 />
    </div>
  );
...
function DataCard25() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-9 self-stretch shrink-0" data-name="DataCard">
      <Container168 />
      <Container169 />
    </div>
  );
...
function DataCard26() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-9 self-stretch shrink-0" data-name="DataCard">
      <Container172 />
      <Container173 />
    </div>
  );
...
function DataCard27() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-10 self-stretch shrink-0" data-name="DataCard">
      <Container176 />
      <Container177 />
    </div>
  );
...
function DataCard28() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-10 self-stretch shrink-0" data-name="DataCard">
      <Container180 />
      <Container181 />
    </div>
  );
...
function DataCard29() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-10 self-stretch shrink-0" data-name="DataCard">
      <Container184 />
      <Container185 />
    </div>
  );
...
function DataCard30() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-11 self-stretch shrink-0" data-name="DataCard">
      <Container188 />
      <Container189 />
    </div>
  );
...
function DataCard31() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-11 self-stretch shrink-0" data-name="DataCard">
      <Container192 />
      <Container193 />
    </div>
  );
...
function DataCard32() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-11 self-stretch shrink-0" data-name="DataCard">
      <Container196 />
      <Container197 />
    </div>
  );
...
function DataCard33() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-12 self-stretch shrink-0" data-name="DataCard">
      <Container200 />
      <Container201 />
    </div>
  );
...
function DataCard34() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-12 self-stretch shrink-0" data-name="DataCard">
      <Container204 />
      <Container205 />
    </div>
  );
...
function DataCard35() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-12 self-stretch shrink-0" data-name="DataCard">
      <Container208 />
      <Container209 />
    </div>
  );
...
function DataCard36() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-13 self-stretch shrink-0" data-name="DataCard">
      <Container212 />
      <Container213 />
    </div>
  );
...
function DataCard37() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-13 self-stretch shrink-0" data-name="DataCard">
      <Container216 />
      <Container217 />
    </div>
  );
...
function DataCard38() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-13 self-stretch shrink-0" data-name="DataCard">
      <Container220 />
      <Container221 />
    </div>
  );
...
function DataCard39() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-14 self-stretch shrink-0" data-name="DataCard">
      <Container224 />
      <Container225 />
    </div>
  );
...
function DataCard40() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-14 self-stretch shrink-0" data-name="DataCard">
      <Container228 />
      <Container229 />
    </div>
  );
...
function DataCard41() {
  return (
    <div className="bg-white col-3 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-14 self-stretch shrink-0" data-name="DataCard">
      <Container232 />
      <Container233 />
    </div>
  );
...
function DataCard42() {
  return (
    <div className="bg-white col-1 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-15 self-stretch shrink-0" data-name="DataCard">
      <Container236 />
      <Container237 />
    </div>
  );
...
function DataCard43() {
  return (
    <div className="bg-white col-2 content-stretch drop-shadow-[0px_4px_7px_rgba(0,0,0,0.25)] flex flex-col items-start justify-between justify-self-stretch min-h-[150px] opacity-45 p-[16px] relative rounded-[17px] row-15 self-stretch shrink-0" data-name="DataCard">
      <Container240 />
      <Container241 />
    </div>
  );
...
function Container67() {
  return (
    <div className="flex-[803_0_0] gap-x-[16px] gap-y-[16px] grid grid-cols-[___257px_257px_257px] grid-rows-[_______________150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_150px_168.75px] h-[2492.75px] min-w-px relative" data-name="Container">
      <DataCard />
      <DataCard1 />
      <DataCard2 />
      <DataCard3 />
...
function CatalogPage4() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pb-[48px] px-[24px] top-[757px] w-[1101px]" data-name="CatalogPage">
      <Container48 />
      <Container49 />
    </div>
  );
...
export default function CatalogAiSearch() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="catalog-ai-search">
      <Body />
      <CatalogPage1 />
      <CatalogPage2 />
      <CatalogPage3 />
