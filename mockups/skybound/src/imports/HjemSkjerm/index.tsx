import svgPaths from "./svg-j2xtd7zrte";
...
function WeatherCard() {
  return (
    <div className="absolute contents left-[25px] top-[259px]" data-name="Weather card">
      <WeatherCard1 />
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents left-[25px] top-[362px]">
      <WeatherCard2 />
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute contents left-[25px] top-[538px]">
      <WeatherCard3 />
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents left-[25px] top-[720px]">
      <WeatherCard4 />
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents left-[22px] top-[823px]">
      <WeatherCard5 />
    </div>
  );
}
...
export default function HjemSkjerm() {
  return (
    <div className="bg-white border border-black border-solid relative size-full" data-name="Hjem skjerm">
