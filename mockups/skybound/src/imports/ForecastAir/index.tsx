import svgPaths from "./svg-0ru2d18bz9";
...
function Frame1() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Roboto:Regular',sans-serif] font-normal gap-[12px] items-center relative shrink-0 text-[#1d1b20]">
    ...
    <div className="relative shrink-0 size-[24px]" data-name="arrow_forward_ios">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g id="arrow_forward_ios">
          <mask height="24" id="mask0_0_153" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
...
function Frame7() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[813px] w-[364px]">
      <Frame1 />
      <ArrowForwardIos />
    </div>
  );
...
function Frame2() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[283px] w-[364px]">
      <Frame3 />
      <ArrowForwardIos1 />
    </div>
  );
...
function Frame5() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[389px] w-[364px]">
      <Frame6 />
      <ArrowForwardIos2 />
    </div>
  );
...
function Frame9() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[495px] w-[364px]">
      <Frame10 />
      <ArrowForwardIos3 />
    </div>
  );
...
function Frame12() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[601px] w-[364px]">
      <Frame13 />
      <ArrowForwardIos4 />
    </div>
  );
...
function Frame15() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-[23px] px-[16px] py-[18px] rounded-[16px] top-[707px] w-[364px]">
      <Frame16 />
      <ArrowForwardIos5 />
    </div>
  );
...
export default function ForecastAir() {
  return (
    <div className="bg-white border border-black border-solid relative size-full" data-name="Forecast - Air">
      <Frame7 />
